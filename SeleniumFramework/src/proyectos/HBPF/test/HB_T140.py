...
@allure.testcase(u"HB-T140 -0335- Transferencia a Terceros ALIAS con concepto Expensas")
@allure.title(u"HB-T140 -0335- Transferencia a Terceros ALIAS con concepto Expensas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T140")
...
class tst_HB_T140(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T140(self):
        try:
