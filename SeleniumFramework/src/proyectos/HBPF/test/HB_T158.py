...
@allure.testcase(u"HB-T158 Constituir Plazo Fijo (Confirmacion)")
@allure.title(u"HB-T158 Constituir Plazo Fijo (Confirmacion)")
@allure.link(u"https://itau-arg.atlassian.net/projects/CDPF?selectedItem=com.atlassian.plugins.atlassian-connect-plugin:com.kanoah.test-manager__main-project-page#!/testCase/CDPF-T197")
...
class tst_HB_T158(unittest.TestCase, stPlazoFijo):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T197(self):
        try:
