...
from SeleniumFramework.constants.excel_constants import (
    USUARIO, CLAVE, OPERACION, CANAL, FECHA_DESDE
)
...
@allure.testcase(u"HB-T150 -0062- Transferencias consulta de comprobantes")
@allure.title(u"HB-T150 -0062- Transferencias consulta de comprobantes")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T150")
...
@allure.description(
    ...
    5-Presionar el botón <b>buscar</b></br>
    6-Clickear en la columna ver sobre el ícono de PDF</br>
    7-Ver ticket</br>
    8 Cerrar sesion
    """
)
class tst_HB_T150(unittest.TestCase, stComprobantes):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T461(self):
        try:
