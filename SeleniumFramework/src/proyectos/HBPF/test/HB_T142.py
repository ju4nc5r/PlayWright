...
@allure.testcase(u"HB-T142 -0337- Transferencia a Terceros ALIAS con concepto Haberes")
@allure.title(u"HB-T142 -0337- Transferencia a Terceros ALIAS con concepto Haberes")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T142")
...
class tst_HB_T142(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T142(self):
        try:
