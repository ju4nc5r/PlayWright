...
@allure.story( u"Transferencias - Agenda de cuentas - Eliminar agenda cliente de otro banco")
@allure.testcase(u"HB-T156 -0353- Agenda de cuentas elimina de agenda cliente de otro banco")
@allure.title(u"HB-T156 -0353- Agenda de cuentas elimina de agenda cliente de otro banco")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T156")
...
class HB_T156(unittest.TestCase, stAgendaDeCuentas, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T195(self):
        try:
            ...
            self.wait(5)
            self.seleccionarClienteOtroBanco(self.desc)
            self.wait(5)
