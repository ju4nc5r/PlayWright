...
@allure.testcase(u"HB-T125 -0318- Transferencia a Terceros CBU con concepto Alquiler")
@allure.title(u"HB-T125 -0318- Transferencia a Terceros CBU con concepto Alquiler")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T125")
...
@allure.description(
    ...
    6-Seleccionar concepto Varios </br>
...
class tst_HB_T125(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T125(self):
        try:
