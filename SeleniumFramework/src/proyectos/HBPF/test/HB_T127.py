...
@allure.testcase(u"HB-T127 -0320- Transferencia a Terceros CBU con concepto Expensas")
@allure.title(u"HB-T127 -0320- Transferencia a Terceros CBU con concepto Expensas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T127")
...
@allure.description(
    ...
    6-Seleccionar concepto Expensas </br>
...
class tst_HB_T127(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T127(self):
        try:
