...
@allure.testcase(u"HB-T129 -0322- Transferencia a Terceros CBU con concepto Haberes")
@allure.title(u"HB-T129 -0322- Transferencia a Terceros CBU con concepto Haberes")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T129")
...
class tst_HB_T129(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T129(self):
        try:
