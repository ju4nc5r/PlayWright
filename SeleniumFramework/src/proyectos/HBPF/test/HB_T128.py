...
@allure.testcase(u"HB-T128 -0321- Transferencia a Terceros CBU con concepto Factura")
@allure.title(u"HB-T128 -0321- Transferencia a Terceros CBU con concepto Factura")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T128")
...
@allure.description(
    ...
    6-Seleccionar concepto Factura </br>
...
class tst_HB_T128(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T128(self):
        try:
