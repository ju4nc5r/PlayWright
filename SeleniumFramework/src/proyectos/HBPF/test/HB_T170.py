...
@allure.story(u'Tus cosas - Protección móvil')
@allure.testcase(u'HB-T170 -0268- Solicitud de seguro Protección móvil')
@allure.title(u'HB-T170 -0268- Solicitud de seguro Protección móvil')
@allure.severity(allure.severity_level.NORMAL)
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T170")
@allure.description(
    u"""
...
class HB_T70(unittest.TestCase, stLogin, stInicio, stSolicitudSeguro):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T209(self):
        try:
