...
@allure.feature(u'Transterencias a terceros con CBU')
@allure.story( u"Transferencia a Terceros con CBU con diversos conceptos")
@allure.testcase(u"HB-T120 -0328- Transferencia a Terceros CBU con concepto Bienes registrables no habitualistas")
@allure.title(u"HB-T120 -0328- Transferencia a Terceros CBU con concepto Bienes registrables no habitualistas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T120")
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u"""Usuario selecciona cuenta origen e ingresa un CBU de otro banco" </br>" </br>
    1-Ir al menú Transferencias </br>
    2-Clickear A terceros con cuenta Itaú </br>
    3-Seleccionar Cuenta de débito </br>
    4-Ingresar CBU de otro banco</br>
    5-ingresar las coordenas + pin
    6-Seleccionar concepto Bienes registralbles no habilitualista </br>
    7-Ingresar importe </br>
    8-Presionar continuar </br>
    9-Validar ticket </br>
    10-Presionar continuar </br>
    11-cerrar session </br>
    """
)

class tst_HB_T120(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T120(self):
        try:
