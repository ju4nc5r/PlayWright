...
@allure.story(u'Transferencia a tereros con ALIAS con diversos conceptos')
@allure.testcase(u"HB-T132 -0342- Transferencia a Terceros ALIAS con concepto Bienes registrables habitualistas")
@allure.title(u"HB-T132 -0342- Transferencia a Terceros ALIAS con concepto Bienes registrables habitualistas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T132")
...
@allure.description(
    ...
    6-Seleccionar concepto Bienes registrables habitualistas</br>
...
class tst_HB_T132(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T132(self):
        try:
