...
@allure.testcase(u"HB-T139 -0334- Transferencia a Terceros ALIAS con concepto Cuota")
@allure.title(u"HB-T139 -0334- Transferencia a Terceros ALIAS con concepto Cuota")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T139")
...
class tst_HB_T139(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T139(self):
        try:
