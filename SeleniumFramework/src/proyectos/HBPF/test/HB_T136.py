...
@allure.testcase(u"HB-T136 -0346- Transferencia a Terceros ALIAS con concepto Suscripcion obligaciones negociables")
@allure.title(u"HB-T136 -0346- Transferencia a Terceros ALIAS con concepto Suscripcion obligaciones negociables")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T136")
...
class tst_HB_T136(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T136(self):
        try:
