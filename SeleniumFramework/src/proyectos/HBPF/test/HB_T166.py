...
@allure.story(u'Tus cosas - Movilidad')
@allure.testcase(u'HB-T166 - Solicitud de seguro movilidad')
@allure.title(u'HB-T166 - Solicitud de seguro movilidad')
@allure.severity(allure.severity_level.NORMAL)
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T166")
@allure.description(
    u"""
...
4-Seleccionar boton Contratar Movilidad. </br>
...
12-Validar los campos Nombre, Linea de producto,Producto, </br> 
   Plan,Suma Asegurada Maxima,costo medio de Pago.
...
class HB_T166(unittest.TestCase, stLogin, stInicio, stSolicitudSeguro):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T205(self):
        try:
