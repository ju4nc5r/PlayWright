...
@allure.story(u'Familia y vos - Accidentes personales')
@allure.testcase(u'HB-T164 -0264- Solicitud de seguro de accidentes personales')
@allure.title(u'HB-T164 -0264- Solicitud de seguro de accidentes personales')
@allure.severity(allure.severity_level.NORMAL)
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T164")
@allure.description(
    u"""
1-Desde las posición consolidada ir al menú Productos </br>
2-Seleccionar Seguros Solicitud </br>  
3-Dirigirse a la seccion Familia y vos </br>
4-Seleccionar boton Contratar Accidentes personales.</br> 
5-Seleccionar un plan AP Basico.</br>
...
17-Validar que se descargue el comprobante 
18-Seleccionar boton continuar </br>
19-Validar que luego de seleccionar el boton continar redirecione a la consolidada </br>
20-Fin  """
)

class HB_T164(unittest.TestCase, stLogin, stInicio, stSolicitudSeguro):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T203(self):
        try:
            ...
            self.solicitarSeguro(
                self.seguro, self.plan, self.medioPago, self.cuenta
            )
