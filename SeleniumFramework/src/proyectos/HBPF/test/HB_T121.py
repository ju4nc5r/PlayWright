...
@allure.testcase(u"HB-T121 -0329- Transferencia a Terceros CBU con concepto Op. inmobiliarias habitualistas")
@allure.title(u"HB-T121 -0329- Transferencia a Terceros CBU con concepto Op. inmobiliarias habitualistas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T121")
...
@allure.description(
    ...
    6-Seleccionar concepto Op. Inmobiliarias habitualistas"</br>
...
class tst_HB_T121(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T121(self):
        try:
