...
@allure.testcase(u"HB-T143 -0338- Transferencia a Terceros ALIAS con concepto Honorarios")
@allure.title(u"HB-T143 -0338- Transferencia a Terceros ALIAS con concepto Honorarios")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T143")
...
@allure.description(
    ...
    6-Seleccionar concepto Honorarios</br>
...
class tst_HB_T143(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T143(self):
        try:
