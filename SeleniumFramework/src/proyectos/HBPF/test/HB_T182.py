...
@allure.testcase(u'HB-T182-0282: Rescate de fondos comunes de inversion por cuotaparte')
@allure.title(u'HB-T182-0282: Rescate de fondos comunes de inversion por cuotaparte')
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u"""Rescate de fondos por cuotaparte</b> </br>
    </br>
    
    1. Desde posicion consolidada acceder a <b>Productos</b>. </br>
    2. Click en <b>Fondos Comunes de inversion</b>-><b>Rescate</b>. </br>
    ...
    6. Seleccionar cuota parte parcial. </br>
    7. Ingresar el valor de cuota parte. </br>
...
class HB_T182(unittest.TestCase, stLogin, stInicio, stRescate):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T457(self):
        try:
            ...
            self.seleccionarCuotaparteParcial(self.monto)
