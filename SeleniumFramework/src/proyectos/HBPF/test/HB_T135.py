...
@allure.testcase(u"HB-T135 -0345- Transferencia a Terceros ALIAS con concepto Op. inmobiliarias")
@allure.title(u"HB-T135 -0345- Transferencia a Terceros ALIAS con concepto Op. inmobiliariras")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T135")
...
class tst_HB_T135(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T135(self):
        try:
