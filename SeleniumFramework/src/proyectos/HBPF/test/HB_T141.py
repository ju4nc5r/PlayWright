...
@allure.testcase(u"HB-T141 -0336- Transferencia a Terceros ALIAS con concepto Factura")
@allure.title(u"HB-T141 -0336- Transferencia a Terceros ALIAS con concepto Factura")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T141")
...
class tst_HB_T141(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T141(self):
        try:
