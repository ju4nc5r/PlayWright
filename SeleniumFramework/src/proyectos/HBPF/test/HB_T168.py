...
@allure.story(u'Tus cosas - Cajero')
@allure.testcase(u'HB-T168 -0269- Solicitud de seguro cajero')
@allure.title(u'HB-T168 -0269- Solicitud de seguro cajero')
@allure.severity(allure.severity_level.NORMAL)
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T168")
@allure.description(
    u"""
1-Desde las posición consolidada ir al menú Productos </br>
2-Seleccionar Seguros Solicitud </br>  
3-Dirigirse a la sección Tus cosas </br>
4-Seleccionar boton Contratar Cajero. </br>
...
class HB_T168(unittest.TestCase, stLogin, stInicio, stSolicitudSeguro):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T207(self):
        try:
            ...
            self.solicitarSeguroSinPlan(self.seguro, self.medioPago, self.cuenta)        
