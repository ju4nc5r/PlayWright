...
from SeleniumFramework.constants.excel_constants import USUARIO, CLAVE, MONTO, CUENTA_DEB, CUENTA_ACRED, MONEDA



@allure.feature(u'Solicitud de compra Dolar MEP(PB)')
@allure.story(u"'Solicitud de compra Dolar MEP(PB)'")
@allure.testcase(u"HB-T392 - Solicitud de compra Dolar MEP(PB)")
@allure.title(u"HB-T392 - Solicitud de compra Dolar MEP(PB)")
...
@allure.description(
    ...
    2- Seleccionar Dolar MEP </br>
    3- Seleccionar Comprar </br>
...
class tst_HB_T394(unittest.TestCase, CV):
    def setUp(self):
        inicio_test(self)

    def test_HB_T394(self):
        try:
