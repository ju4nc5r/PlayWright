...
@allure.testcase(u"HB-T122 -0317- Transferencia a Terceros CBU con concepto Varios")
@allure.title(u"HB-T122 -0317- Transferencia a Terceros CBU con concepto Varios")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T124")
...
class tst_HB_T124(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T124(self):
        try:
