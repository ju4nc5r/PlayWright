...
@allure.testcase(u"HB-T119 -0327- Transferencia a Terceros CBU con concepto Bienes registrables habitualistas")
@allure.title(u"HB-T119 -0327- Transferencia a Terceros CBU con concepto Bienes registrables habitualistas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T119")
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u"""Usuario selecciona cuenta origen e ingresa un CBU de otro banco" </br>
    ...
    6-Seleccionar concepto Bienes registralbles habilitualista </br>
...
class tst_HB_T119(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T119(self):
        try:
