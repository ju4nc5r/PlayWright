...
@allure.testcase(u"HB-T118 -0326- Transferencia a Terceros CBU con concepto Aporte de Capital")
@allure.title(u"HB-T118 -0326- Transferencia a Terceros CBU con concepto Aporte de Capital")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T118")
...
@allure.description(
    ...
    6-Seleccionar concepto Aporte de Capital</br>
...
class tst_HB_T118(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T118(self):
        try:
