...
@allure.testcase(u"HB-T138 -0333- Transferencia a Terceros ALIAS con concepto Alquiler")
@allure.title(u"HB-T138 -0333- Transferencia a Terceros ALIAS con concepto Alquiler")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T138")
...
@allure.description(
    ...
    6-Seleccionar concepto Alquiler</br>
...
class tst_HB_T138(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T138(self):
        try:
