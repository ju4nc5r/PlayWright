...
@allure.story(u'Tus cosas - Compra protegida')
@allure.testcase(u'HB-T171 - Solicitud de seguro Compra protegida')
@allure.title(u'HB-T171 - Solicitud de seguro Compra protegida')
@allure.severity(allure.severity_level.NORMAL)
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T171")
@allure.description(
    u"""
1-Desde las posición consolidada ir al menú Productos </br>
2-Seleccionar Seguros  </br>
3-Dirigirse a la seccion Tus cosas</br>
4-Seleccionar boton contratar Compra protegida </br>
5-Seleccionar PLAN B </br>
...
class HB_T71(unittest.TestCase, stLogin, stInicio, stSolicitudSeguro):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T210(self):
        try:
