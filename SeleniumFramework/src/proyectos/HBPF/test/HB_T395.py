...
@allure.feature(u'Solicitud de venta Dolar MEP(PB)')
@allure.story(u"'Solicitud de venta Dolar MEP(PB)'")
@allure.testcase(u"HB-T392 - Solicitud de venta Dolar MEP(PB)")
@allure.title(u"HB-T392 - Solicitud de venta Dolar MEP(PB)")
