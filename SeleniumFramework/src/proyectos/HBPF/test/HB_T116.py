...
@allure.story(u"Realizar una transferencia de venta de dolares desde 'Transferencias'")
...
@allure.description(
    ...
    extranjera</b> </br>
    3-Seleccionar cuenta de débito en U$S </br>
    4-Seleccionar cuenta de acreditación en $ </br>
...
class tst_HB_T116(unittest.TestCase, CV):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T155(self):
        try:
