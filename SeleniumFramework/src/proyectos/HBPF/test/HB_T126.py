...
@allure.testcase(u"HB-T126 -0319- Transferencia a Terceros CBU con concepto Cuota")
@allure.title(u"HB-T126 -0319- Transferencia a Terceros CBU con concepto Cuota")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T126")
...
@allure.description(
    ...
    6-Seleccionar concepto Cuota </br>
...
class tst_HB_T126(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T126(self):
        try:
