...
@allure.testcase(u'HB-T172 - Solicitud de seguro Negocio')
@allure.title(u'HB-T172 - Solicitud de seguro Negocio')
@allure.severity(allure.severity_level.NORMAL)
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T172")
@allure.description(
    u"""
1-Desde las posición consolidada ir al menú Productos </br>
2-Selecionar Seguros solicitud </br>   
3-Dirigirse a la sección Negocio </br>
4-Selecionar el boton Contratar  </br>
5-Validar que se realice el salto de sito a   </br>
https://www.itau.com.ar/seguros/Paginas/seguros-para-tu-patrimonio.aspx#negocios</br>
...
class HB_T172(unittest.TestCase, stLogin, stInicio, stSolicitudSeguro):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T211(self):
        try:
            ...
            self.verificar_salto_a_itau_seguros_negocios()
            self.finalizo = True
        except Exception:
