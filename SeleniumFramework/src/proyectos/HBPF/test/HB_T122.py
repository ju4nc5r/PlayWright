...
@allure.testcase(u"HB-T122 -0330- Transferencia a Terceros CBU con concepto Op. inmobiliarias")
@allure.title(u"HB-T122 -0330- Transferencia a Terceros CBU con concepto Op. inmobiliariras")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T122")
...
@allure.description(
    ...
    6-Seleccionar concepto Op. Inmobiliarias </br>
...
class tst_HB_T122(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T122(self):
        try:
