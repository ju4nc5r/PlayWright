...
@allure.testcase(u"HB-T131 -0341- Transferencia a Terceros ALIAS con concepto Aporte de Capital")
@allure.title(u"HB-T131 -0341- Transferencia a Terceros ALIAS con concepto Aporte de Capital")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T131")
...
class tst_HB_T131(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T131(self):
        try:
