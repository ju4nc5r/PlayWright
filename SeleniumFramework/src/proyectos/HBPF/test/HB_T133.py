...
@allure.testcase(u"HB-T133 -0343- Transferencia a Terceros ALIAS con concepto Bienes registrables no habitualistas")
@allure.title(u"HB-T133 -0343- Transferencia a Terceros ALIAS con concepto Bienes registrables no habitualistas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T133")
...
@allure.description(
    ...
    6-Seleccionar concepto Bienes registrables no habitualistas</br>
...
class tst_HB_T133(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T133(self):
        try:
