...
@allure.testcase(u"HB-T134 -0344- Transferencia a Terceros ALIAS con concepto Op. Inmobiliaras habitualistas")
@allure.title(u"HB-T134 -0344- Transferencia a Terceros ALIAS con concepto Op. Inmobiliaras habitualistas")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T134")
...
@allure.description(
    ...
    6-Seleccionar concepto Op. Inmobiliaras habitualistas</br>
...
class tst_HB_T134(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T134(self):
        try:
