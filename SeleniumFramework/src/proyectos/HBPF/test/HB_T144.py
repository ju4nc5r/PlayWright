...
@allure.testcase(u"HB-T144 -0339- Transferencia a Terceros ALIAS con concepto Prestamos")
@allure.title(u"HB-T144 -0339- Transferencia a Terceros ALIAS con concepto Prestamos")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T144")
...
@allure.description(
    ...
    6-Seleccionar concepto Prestamos</br>
...
class tst_HB_T144(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T144(self):
        try:
