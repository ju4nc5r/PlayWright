...
@allure.testcase(u"HB-T130 -0323- Transferencia a Terceros CBU con concepto Honorarios")
@allure.title(u"HB-T130 -0323- Transferencia a Terceros CBU con concepto Honorarios")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T130")
...
@allure.description(
    ...
    6-Seleccionar concepto Haberes </br>
...
class tst_HB_T130(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T130(self):
        try:
