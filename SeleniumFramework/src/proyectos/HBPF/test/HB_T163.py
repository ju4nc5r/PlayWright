...
@allure.story(u'Familia y vos - Seguro de vida')
@allure.testcase(u'HB-T163 -0272- Solicitud de seguro de vida')
@allure.title(u'HB-T163 -0272- Solicitud de seguro de vida')
@allure.severity(allure.severity_level.NORMAL)
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T163")
@allure.description(
    u"""
...
4-Seleccionar boton Contratar Seguro de vida</br> 
5-Seleccionar plan RENT-01</br>
...
class HB_T163(unittest.TestCase, stLogin, stInicio, stSolicitudSeguro):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T202(self):
        try:
