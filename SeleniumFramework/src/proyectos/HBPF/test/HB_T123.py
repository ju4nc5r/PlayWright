...
@allure.testcase(u"HB-T122 -0331- Transferencia a Terceros CBU con concepto Suscripcion obligaciones negociables")
@allure.title(u"HB-T122 -0331- Transferencia a Terceros CBU con concepto Op. Suscripcion obligaciones negociables")
@allure.link(u"https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/HB-T123")
...
@allure.description(
    ...
    6-Seleccionar concepto Suscripcion obligaciones negociables </br>
...
class tst_HB_T123(unittest.TestCase, stTT, stLogin):
    def setUp(self):
        inicio_test(self)

    def test_HB_T123(self):
        try:
