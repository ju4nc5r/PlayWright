...
@allure.feature(u'Solicitud de compra Dolar MEP(CG)')
@allure.story(u"'Solicitud de compra Dolar MEP(CG)'")
@allure.testcase(u"HB-T392 - Solicitud de compra Dolar MEP(CG)")
@allure.title(u"HB-T392 - Solicitud de compra Dolar MEP(CG)")
...
class tst_HB_T392(unittest.TestCase, CV):
    def setUp(self):
        inicio_test(self)

    def test_HB_T392(self):
        try:
