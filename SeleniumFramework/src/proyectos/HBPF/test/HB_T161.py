...
@allure.story(u'Consulta de CBU /Alias - PB')
@allure.testcase(u"HB-T161 -0382- Consulta de CBU /Alias PB")
@allure.title(u'HB-T161 -0382- Consulta de CBU /Alias PB')
@allure.link(u"https://itau-arg.atlassian.net/projects/CDPF?selectedItem=com.atlassian.plugins.atlassian-connect-plugin:com.kanoah.test-manager__main-project-page#!/testCase/CDPF-T200")
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u""" 
    1- En posicion consolidada, hacer click en la opcion Productos/cuentas
...
class HB_T161(unittest.TestCase, stLogin, stInicio, stConsultaCBUyAlias):
    def setUp(self):
        inicio_test(self)

    def test_CDPF_T200(self):
        try:
