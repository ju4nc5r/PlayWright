...
@allure.story(u'Compra de Titulos')
@allure.testcase(u"Mesa_Web - INV-T276 - Compra de Titulos")
@allure.title(u'Mesa_Web - INV-T276 - Compra de Titulos')
...
class INV_T276(unittest.TestCase, stMesaWebInicio, stMesaWebPerfil,stMesaWebOperaciones, stMesaWebBandeja):
    def setUp(self):
        inicioMesaWeb(self)
        
    def test_INV_T276(self):
        try:
            ...
            self.seleccionar_compra()
            self.abrir_tipoCliente()
            self.seleccionar_item_nro_cliente()
            self.completarNroCliente(self.numero_cliente)
            ...
            self.ingresar_instrumento(self.instrumento)
            self.select_btn_siguiente(pl_MesaWebOperaciones.btn_siguiente)
            self.ingresar_cantidad(self.cantidad)
            self.ingresar_precio_2()
            self.seleccionar_btn_compra_del_banco()
    ...
    def getDatos(self):
        ...
        self.numero_cliente = self.usuario.get(NROCLIENTE)
        self.orden = ""
