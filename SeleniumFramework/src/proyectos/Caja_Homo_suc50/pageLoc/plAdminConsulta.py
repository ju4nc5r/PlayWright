...
class plAdminConsulta():
    ...
    btn_buscarMovi = "//button[@type='submit'][contains(.,'Buscar')]"
    btn_buscar = "//button[contains(.,'Buscar')]"
    btn_salir2 = "//span[contains(.,'Salir')]"
    ...
    btn_Imprimir_1 = "(//button[contains(.,'Imprimir')])[1]"
    ...
    opt_sucursal = "//span[@class='ng-tns-c12-7 ng-star-inserted'][contains(.,'{}')]"
#     opt_sucursal = "//mat-option[contains(.,'{}')]"
    ...
    ipt_importe = "(//div[contains(.,'Importe')])[10]" 
    
    #ipt_importe = "//input[contains(@formcontrolname,'valor')]"

    ipt_fecha = "//input[contains(@formcontrolname,'pickerDesde')]"

    btn_imprmirTicket = "//td[contains(@class,'cdk-column-imprimir')]"

    btn_preview = "//td[contains(@class,'cdk-column-preview')]"
