...
class plAdminSucursales():
    ...
    btn_aceptar_2 = "//button[@class='btnYes'][contains(.,'Aceptar')]"
# Para ver despues
#     msgOk=""//div[@class='mat-dialog-content'][contains(.,'Se ha asignado correctamente el operador centralizador:UIC10022  .
