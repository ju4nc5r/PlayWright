...
@allure.testcase(u'SUC-T861 Depósito en efectivo de 3° inferior a $ 280,000')
@allure.title(u'SUC-T861 Depósito en efectivo de 3° inferior a $ 280,000 Por Alias')
...
class SUC_T861(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T861(self):
        try:
            ...
            self.visualizarDatosDeposito3ros2(self.importe,self.cuenta5,"pesos")
