...
@allure.testcase(u"ICaja - SUC-T841 - Extracción de Efectivo - Moneda Euros")
@allure.title(u'SUC-T841 -  Extracción de Efectivo Cuenta Euros - Moneda Euros')
@allure.link(u'https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/35766')
...
class SUC_T841(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T841(self):
        try:
