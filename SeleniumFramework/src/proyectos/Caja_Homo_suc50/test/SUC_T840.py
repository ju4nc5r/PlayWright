...
@allure.testcase(u"ICaja - SUC-T840 - Extracción de Efectivo - Moneda Dolares")
@allure.title(u'SUC-T840 - Extracción de Efectivo Cuenta Dolares - Moneda Dolares')
...
class SUC_T840(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T840(self):
        try:
