...
@allure.story(u'Terminales registrados')
@allure.testcase(u"Adm.Caja -SUC-T334 - Administracion de cajas - Consultas - Saldos de caja ")
@allure.title(u'SUC-T334 - Consultas - Saldos de caja')
...
7-Visualizar el Titulo Consultas Saldos de Caja </br>  
8-Validar que el Item Condición este "Todos" </br>  
9-Validar Sucursal "0050 - Puerto Madero" </br>  
10-Hacer clic en el Botón Buscar </br>  
11-Visualizar en pantalla los saldos de caja. </br>  
12-Hacer clic en el Boton Imprimir </br>  
13-Hacer clic en el Boton Salir. </br>  
   
    """
)
class SUC_T334(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def test_SUC_T334(self):
        try:
