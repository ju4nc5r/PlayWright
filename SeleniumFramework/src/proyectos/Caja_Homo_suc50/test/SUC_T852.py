...
@allure.testcase(u"ICaja - SUC-T852 Pagos Varios - Moneda Pesos") 
@allure.title(u'SUC-T852 - Pagos Varios')
...
7.-Seleccionar el ítem "50 Gastos Generales"</br>
8.-Hacer clic en seleccionar Moneda a extraer "Pesos"</br>
9.-Ingresar importe "1.000,00"</br>
...
class SUC_T852(unittest.TestCase, stICajaInicio, stICaja,stAutorizInicio, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T852(self):
        try:
