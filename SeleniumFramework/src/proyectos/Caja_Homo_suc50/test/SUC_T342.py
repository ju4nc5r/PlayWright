...
@allure.testcase( u"SUC-T342 - Consultas de Movimientos de caja - Imprimir")
@allure.link(u'https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/BOX-T354')
@allure.title(u'SUC-T342 - consulta de Movimientos de caja - Imprimir')
...
12-Hacer click en imprimir. </br>  
13-Hacer clic en el Boton Salir. </br>           
"""
)
class SUC_T342 (unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def test_SUC_T342(self):
        try:
