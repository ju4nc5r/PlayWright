...
@allure.testcase(u"SUC-T354 - Consultas - Totales ingresos, egresos y líquido de caja - Euros")
@allure.title(u'SUC-T354 - Consultas - Euros')
...
8-Validar el item Moneda y Seleccionar Euros </br>  
...
class SUC_T354(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def test_SUC_T354(self):
        try:
