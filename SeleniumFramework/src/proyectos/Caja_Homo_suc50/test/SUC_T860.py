...
from SeleniumFramework.constants.excel_constants import USUARIO, LEGAJO, TERMINAL, SUCURSAL,CLAVE,\
              APELLIDO, NOMBRE, MONEDA, IMPORTE1, MSJ_ESPERADO,CUENTA1,CUENTA2,CUENTA3,CUENTA4,CUENTA5,\
...
@allure.testcase(u'SUC-T860 Depósito en efectivo de 3° inferior a $ 280,000')
@allure.title(u'SUC-T860 Depósito en efectivo de 3° inferior a $ 280,000 Por CBU' )
@allure.link(u'https://jira.sis.ad.bia.itau/secure/Tests.jspa#/testCase/35840')
...
class SUC_T860(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T860(self):
        try:
            ...
            self.visualizarDatosDeposito3ros2(self.importe,self.cuenta3,"pesos")
