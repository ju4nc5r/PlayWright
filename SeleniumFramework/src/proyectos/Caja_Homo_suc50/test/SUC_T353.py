...
@allure.testcase(u"SUC-T353 - Consultas - Totales ingresos, egresos y líquido de caja - Dolares")
@allure.title(u'SUC-T353 - Consultas - Dolares')
...
8-Validar el item Moneda y Seleccionar Dolares </br>  
...
class SUC_T353(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def test_SUC_T353(self):
        try:
