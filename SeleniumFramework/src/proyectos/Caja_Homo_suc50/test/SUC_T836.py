...
@allure.testcase(u"SUC-T836 - Consulta de Saldos - Cajero")
@allure.title(u'SUC-T836 - Consulta de Saldos - Cajero')
...
6.-Verificar los Saldos de Caja, y Saldo CAF. Moneda Pesos - Dolares - Euros - Reales </br>
7.-Hacer clic en el botón "SALIR"</br>
9.-Hacer clic en el recuadro Hola, UIC10021</br>
10.-Hacer clic en CERRAR SESIÓN</br>
"""
)
class SUC_T836(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T836(self):
        try:
            ...
            for posicion,moneda in zip(self.posiciones,self.monedas):       
                ...
                print("Saldo de Caja en {}".format(moneda),":",self.monedaSaldo)
                print("Saldo de Caf en {}".format(moneda),":",self.monedaSaldoCaf)     
            self.cerrarSesion()
            self.finalizo = True
        except Exception:
