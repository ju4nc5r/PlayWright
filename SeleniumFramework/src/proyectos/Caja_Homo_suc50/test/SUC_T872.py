...
@allure.testcase(u"SUC-T872 - Depósito Plazo Fijo Débito en Cuenta - Plazo Días")
@allure.title(u'SUC-T872- Deposito a Plazo Fijo en Cuenta')
...
14.-Seleccionar cuenta "CA $ /0000678-301/4 "</br>
15.-Hacer clic en el recuadro "Tipo de plazo fijo"</br>
16.-Seleccionar item "PF. MAX"</br>
17.-Hacer clic en el check del recuadro Plazo Dias</br>
18.-Hacer clic en el recuadro "Plazo Dias"e Ingresar: "35"</br>
...
class SUC_T872(unittest.TestCase, stICajaInicio, stICaja , stICajaTickets):
    def setUp(self):
        inicioICaja(self)
