# -*- coding: utf-8 -*-
from SeleniumFramework.src.proyectos.Caja_Inte.pageLoc.plAutorizInicio import plAutorizInicio
from SeleniumFramework.src.proyectos.Caja_Inte.st.pasos import abrirNavegador
from SeleniumFramework.common_functions import get_msg
from SeleniumFramework.src.proyectos.Caja_Inte import settings
...
class stAutorizInicio(abrirNavegador):
    ...
    def seleccionarIngresarLogin(self):
        ...
        msgOk, msgFail = get_msg(accion)
        with self.step(accion):
            xpath = plAutorizInicio.btn_aceptar
...
#     
    ...
    def autorizarOperacion(self):#,usuario="UIC10003",term="IBA0003",clave="Testicaja03"):
        self.abrirAdmAutorizaciones()
        self.seleccionar_aceptar_msg_Error()
        self.completarUsuarioLoginAut("UIC10004")
        self.completarTerminalLoginAut("IA0460804")
        self.completarClaveLoginAut("Testicaja04")        
        self.seleccionarIngresarLoginAut()
        self.validarHolaUsuarioAut('Hola '+ "IA0460804" + ' !')
    ...
    def autorizarOperacionPg(self):#,usuario="UIC10003",term="IBA0003",clave="Testicaja03"):
        self.abrirAdmAutorizaciones()
        self.seleccionar_aceptar_msg_Error()
        self.completarUsuarioLoginAut("UIC10004")
        self.completarTerminalLoginAut("IA0460804")
        self.completarClaveLoginAut("Testicaja04")        
        self.seleccionarIngresarLoginAut()
        self.validarHolaUsuarioAut('Hola '+ "UIC10004" + ' !')
        self.seleccionarCheckSupervisor()
        self.validarNroAutorizacion()
        self.seleccionarIcnAutorizar()
        self.seleccionarBtnAutorizar()
    ...
    def autorizarOperacionSucursal50(self):#,usuario="UIC10023",term="IBA0023",clave="Ingreso23"):
        self.abrirAdmAutorizaciones()
        self.seleccionar_aceptar_msg_Error()
        self.completarUsuarioLoginAut("UIC10023")
        self.completarTerminalLoginAut("IBA0023")
        self.completarClaveLoginAut("Ingreso23")        
        self.seleccionarIngresarLoginAut()
        self.validarHolaUsuarioAut('Hola '+ "UIC10023" + ' !')
        self.seleccionarCheckSupervisor()
        self.validarNroAutorizacion()
        self.seleccionarIcnAutorizar()
        self.seleccionarBtnAutorizar()
    ...
    def autorizarPagoDeCheque(self):#,usuario="UIC10003",term="IBA0003",clave="Testicaja03"):
        self.abrirAdmAutorizaciones()
        self.seleccionar_aceptar_msg_Error()
        self.completarUsuarioLoginAut("UIC10004")
        self.completarTerminalLoginAut("IA0460804")
    ...
    def rechazarOperacion(self):#,usuario="UIC10003",term="IBA0003",clave="Testicaja03"):
        self.abrirAdmAutorizaciones()
        self.seleccionar_aceptar_msg_Error()
        self.completarUsuarioLoginAut("UIC10004")
        self.completarTerminalLoginAut("IA0460804")
    ...
    def seleccionar_aceptar_msg_Error(self):
        to = 10
        accion = u'Seleccionar aceptar en mensaje Error: Ocurrio un error al obtener la terminal del usuario '
        msgOk, msgFail = get_msg(accion)
        with self.step(accion):
            xpath = plAutorizInicio.btn_aceptar_msg
            xpath2 = plAutorizInicio.msg_error
