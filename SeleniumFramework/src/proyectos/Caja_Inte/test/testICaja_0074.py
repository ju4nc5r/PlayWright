...
@allure.testcase(
    u"Test_074 - Egreso Externo del Numerario", u''
)
@allure.title(u'Test_074 - Egreso Externo del Numerario - Pesos')
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u"""
    1-Ingresar a la pagina Icaja.
    2-Realizar login
    3-Igresar  usuario y password y hacer clik en Aceptar.
    ...
    7-Hacer clic en la opcion Egreso Externo del Numerario
    8-Selecionar Moneda
    9-Hacer clic y seleccionar  monedas "Pesos"
    ...
    13-Ingresar valor (120)
    14-Hacer click  en el Boton siguiente
    15-Impresion ok 
    """
)
class tstICaja_0074(unittest.TestCase, stICajaInicio, stICaja,stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0074(self):
        try:
