...
@allure.testcase(
    u"test_0082 - Consultas de Movimientos de caja - Descargar", u''
)
@allure.title(u'test_0082 - consulta de Movimientos de caja - Descargar')
...
@allure.description(
    ...
    6-Hacer click en Descargar
    7-Hacer click  en el Boton Salir "Salir de la aplicacion"    
    """
)

class tstAdmCaja_0082(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0082(self):
        try:
