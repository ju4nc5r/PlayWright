...
@allure.testcase(
    u"ICaja - Caso de Prueba 0021", u''
)
@allure.title(u'Test_0021 - Identificar Cliente con LE ')
...
@allure.description(
    ...
    6- Seleccionar Tipo de Documento "LE"</br>
...
class tstICaja_0021(unittest.TestCase, stICajaInicio, stICaja):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0021(self):
        try:
