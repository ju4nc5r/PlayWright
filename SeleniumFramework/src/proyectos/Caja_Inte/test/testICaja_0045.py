...
@allure.testcase(
    u"ICaja - Caso 0045 - Venta Moneda Extranjera - Reales", u''
)
@allure.title(u'test_0045 - Venta Moneda Extranjera - Reales')
...
@allure.description(
    ...
    16-Seleccionar el campo Monedas (Reales)
    17-Seleccionar importe a vender 
    18-Ingresar Importe Reales 8
...
class tstICaja_0045(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0045(self):
        try:
