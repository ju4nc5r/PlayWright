...
@allure.testcase(
    u"Test_082 - Deposito Efectivo", u''
)
@allure.title(u'Test_082 - Deposito Efectivo - Euros en cuenta en pesos')
...
class tstICaja_0082(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0082(self):
        try:
