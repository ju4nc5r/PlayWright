...
@allure.testcase(
    u"Test_080 - Deposito Efectivo", u''
)
@allure.title(u'Test_080 - Deposito Efectivo - Peso en cuenta en pesos')
...
class tstICaja_0080(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0080(self):
        try:
