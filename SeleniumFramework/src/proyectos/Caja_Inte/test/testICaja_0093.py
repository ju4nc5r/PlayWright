...
@allure.testcase(
    u"test_0093 - Ingreso Interno del Numerario - reales", u''
)
@allure.title(u'test_0093 - Ingreso Interno del Numerario - reales')
...
class tstICaja_0093(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0093(self):
        try:
