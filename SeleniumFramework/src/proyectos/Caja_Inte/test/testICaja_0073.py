...
@allure.testcase(
    u"test_0073 - Ingreso Externo del Numerario - Reales", u''
)
@allure.title(u'test_0073 - Ingreso Externo del Numerario - Reales')
...
@allure.description(
    ...
    12-Ingresar en numero control (0103)    
    13-Ingresar valor (1500)  
...
class tstICaja_0073(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0073(self):
        try:
