...
@allure.testcase(
    u"test_0072 - Ingreso Externo del Numerario - Euros", u''
)
@allure.title(u'test_0073 - Ingreso Externo del Numerario - Euros')
...
@allure.description(
    ...
    12-Ingresar en numero control (0102)    
...
class tstICaja_0072(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0072(self):
        try:
