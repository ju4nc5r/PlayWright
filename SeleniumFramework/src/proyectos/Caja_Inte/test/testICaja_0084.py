...
@allure.testcase(
    u"Test_084 - Deposito Efectivo", u''
)
@allure.title(u'Test_084 - Deposito Efectivo - Dolares en cuenta en dolares')
...
class tstICaja_0084(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0084(self):
        try:
