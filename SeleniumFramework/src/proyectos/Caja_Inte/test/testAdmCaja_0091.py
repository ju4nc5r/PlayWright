...
@allure.testcase(
    u"test_0091 - Consultas - Totales ingresos, egresos y líquido de caja - Dolares", u''
)
@allure.title(u'test_0091 - Consultas - Dolares')
...
class tstAdmCaja_0091(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0091(self):
        try:
