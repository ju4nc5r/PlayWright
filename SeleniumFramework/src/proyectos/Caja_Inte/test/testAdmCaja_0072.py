...
from proyectos.Caja_Homo.pageLoc.plAdminConsulta import plAdminConsulta

@allure.feature(u'Administracion de cajas')
@allure.story(u'Consultas - Administracion de cajas')
@allure.testcase(
    u"Adm.Caja - Caso de Prueba 0072", u''
)
@allure.title(u'test_0072 - Consulta de saldos de caja - Totales de saldos por sucursal')
...
class tstAdmCaja_0072(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0072(self): 
        try:
