...
@allure.testcase(
    u"test_0095 - Ingreso Interno del Numerario - dolares", u''
)
@allure.title(u'test_0095 - Ingreso Interno del Numerario - dolares')
...
class tstICaja_0095(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0095(self):
        try:
