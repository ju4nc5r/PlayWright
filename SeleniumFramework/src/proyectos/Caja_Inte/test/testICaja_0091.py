...
@allure.testcase(
    u"test_0091 - Ingreso Interno del Numerario - Dolares", u''
)
@allure.title(u'test_0091 - Ingreso Interno del Numerario - dolares')
...
@allure.description(
    ...
    4-Seleccionar Moneda dolares
    5-Ingresar Valor 2000
...
class tstICaja_0091(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0091(self):
        try:
