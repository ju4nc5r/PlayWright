...
@allure.testcase(
    u"ICaja - Caso 0043 - Venta Moneda Extranjera - Dolares", u''
)
@allure.title(u'test_0043 - Venta Moneda Extranjera - Dolares')
...
@allure.description(
    ...
    16-Seleccionar el campo Monedas (Dolares)
    17-Seleccionar importe a vender 
    18-Ingresar Importe Dolares 5
...
class tstICaja_0043(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0043(self):
        try:
