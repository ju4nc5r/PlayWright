...
@allure.testcase(u'SUC-T838 Depósito en efectivo de 3° inferior a $ 280,000')
@allure.title(u'SUC-T838 - Depósito en efectivo de 3° inferior a $ 280,000 Por Nro de Cuenta')
...
class SUC_T838(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T838(self):
        try:
            ...
            self.visualizarDatosDeposito3ros2(self.importe,self.cuenta1,"pesos")
