...
@allure.story(u'Consulta de Saldos Sucursal')
@allure.testcase(u"SUC-T801 - Consulta de Saldos Sucursal - Operador (Nivel Cajero)")
@allure.title(u'SUC-T801 - Consulta de Saldos Sucursal - Operador (Nivel Cajero)')
...
class SUC_T801(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T801(self):
        try:
