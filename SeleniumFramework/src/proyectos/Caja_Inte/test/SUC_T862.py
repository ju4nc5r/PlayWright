...
@allure.testcase(u'SUC-T862 Depósito en efectivo de 3° Inferior a $ 280,000 - Por Raiz' )
@allure.title(u'SUC-T862 Depósito en efectivo de 3°  Inferior a $ 280,000 - Por Raiz')
...
4.-Validar nombre del Operador "Hola, UIC10009</br> 
...
17.-Hacer clic en el recuadro Hola, UIC10009</br> 
18.-Hacer clic en CERRAR SESIÓN </br>          
 </br> 
    """
)
class SUC_T862(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T862(self):
        try:
            ...
            self.visualizarDatosDeposito3ros2(self.importe,self.cuenta4,"pesos")
