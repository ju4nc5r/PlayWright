...
@allure.testcase(
    u"test_0061 - Extraccion en dólares de cuenta en pesos", u''
)
@allure.title(u'test_0061 - Extraccion en dólares de cuenta en pesos')
...
@allure.description(
    ...
    15-Seleccionar  cuenta  CC en pesos
    16-Hacer clic en seleccionar Moneda  a extraer
    17-Seleccionar Moneda dolares
    18-Ingresar importe 60 dolares
    19--Hacer clic en Siguiente
    20-Marcar el check si coincide la firma
    21- Visualizar y validar los datos del cliente e importe a Extraer
    22-Confirmar
    23-Visualizar impresion
    """
)
class tstICaja_0061(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0061(self):
        try:
