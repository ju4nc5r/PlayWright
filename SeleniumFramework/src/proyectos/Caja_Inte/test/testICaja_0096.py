...
@allure.testcase(
    u"test_0096 - Ingreso Interno del Numerario - euros", u''
)
@allure.title(u'test_0096 - Ingreso Interno del Numerario - euros')
...
class tstICaja_0096(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0096(self):
        try:
