...
@allure.testcase(
    u"Adm.Caja - Caso de Prueba 0050", u''
)
@allure.title(u'test_0050 - consulta de operadores registrados')
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u"""
    1-Ingresar a la pagina Administracion de cajas  
    2-Colocar  el usuario y password y hacer clik en Aceptar.  
    3-Hacer click en consultas - operadores registrados  
    4-Validar que contenga informacion </br
    5-Hacer click  en el Boton Salir "Salir de la aplicacion"
    """
)
class tstAdmCaja_0050(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0050(self):
        try:
