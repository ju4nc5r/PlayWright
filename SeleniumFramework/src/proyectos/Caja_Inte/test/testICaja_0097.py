...
@allure.testcase(
    u"test_0097 - Ingreso Interno del Numerario - euros", u''
)
@allure.title(u'test_0097 - Ingreso Interno del Numerario - euros')
...
class tstICaja_0097(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0097(self):
        try:
