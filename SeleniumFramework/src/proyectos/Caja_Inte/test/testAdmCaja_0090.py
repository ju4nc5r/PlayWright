...
@allure.testcase(
    u"test_0090 - Consultas - Totales ingresos, egresos y líquido de caja - Pesos", u''
)
@allure.title(u'test_0090 - Consultas - Pesos')
...
class tstAdmCaja_0090(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0090(self):
        try:
