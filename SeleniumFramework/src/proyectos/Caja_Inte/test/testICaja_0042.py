...
@allure.testcase(
    u"ICaja - Caso 0042 - Compra Moneda Extranjera - Reales", u''
)
@allure.title(u'test_0042 - Compra Moneda Extranjera - Reales')
...
@allure.description(
    ...
    15-Seleccionar el campo Monedas (Reales)
    16-Seleccionar importe a comprar 
    17-Ingresar Importe 8 Reales
...
class tstICaja_0042(unittest.TestCase, stICajaInicio, stICaja,stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0042(self):
        try:
