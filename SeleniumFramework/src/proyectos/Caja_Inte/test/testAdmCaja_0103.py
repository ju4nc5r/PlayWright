...
@allure.testcase(
    u"Adm.Caja - Caso de Prueba 0103", u''
)
@allure.title(u'test_0103 - Consultas - Listados Multiples - Reales')
...
class tstAdmCaja_0103(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0103(self):
        try:
