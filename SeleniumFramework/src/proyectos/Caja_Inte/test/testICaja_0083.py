...
@allure.testcase(
    u"Test_083 - Deposito Efectivo", u''
)
@allure.title(u'Test_083 - Deposito Efectivo - Reales en cuenta pesos')
...
@allure.description(
    ...
    17-Seleccionar Moneda Reales
    18-Ingresar importe 20
...
class tstICaja_0083(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0083(self):
        try:
