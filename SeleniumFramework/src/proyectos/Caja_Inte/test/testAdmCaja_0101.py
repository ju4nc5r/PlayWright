...
@allure.testcase(
    u"Adm.Caja - Caso de Prueba 0101", u''
)
@allure.title(u'test_0101 - Consultas - Listados Multiples - Dolares')
...
class tstAdmCaja_0101(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0101(self):
        try:
