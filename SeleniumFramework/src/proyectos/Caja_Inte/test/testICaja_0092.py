...
@allure.testcase(
    u"test_0092 - Ingreso Interno del Numerario - Euros", u''
)
@allure.title(u'test_0092 - Ingreso Interno del Numerario - Pesos')
...
class tstICaja_0092(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0092(self):
        try:
