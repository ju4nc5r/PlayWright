...
@allure.testcase(
    u"Adm.Caja - Caso de Prueba 0071", u''
)
@allure.title(u'test_0071 - Consulta de saldos de caja - Imprimir')
...
class tstAdmCaja_0071(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0071(self):
        try:
