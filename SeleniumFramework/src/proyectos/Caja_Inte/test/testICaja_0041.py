...
@allure.testcase(
    u"ICaja - Caso 0041 - Compra Moneda Extranjera", u''
)
@allure.title(u'test_0041 - Compra Moneda Extranjera - Euros')
...
@allure.description(
    ...
    15-Seleccionar el campo Monedas (Euros)
    16-Seleccionar importe a comprar 
    17-Ingresar Importe 7 Euros 
...
class tstICaja_0041(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0041(self):
        try:
