...
from SeleniumFramework.constants.excel_constants import USUARIO, LEGAJO, TERMINAL, SUCURSAL,\
             CLAVE, TIPO_DOC_IDENTIF, NRO_DOC_IDENTIF, NOMBRE, APELLIDO


@allure.feature(u'ICaja')
@allure.story(u'Identificar Cliente')
@allure.testcase(
    u"ICaja - Caso de Prueba 0030", u''
)
@allure.title(u'Test_0030 - Identificar Cliente con CUIL')
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u"""1-Ingresar a la pagina Icaja. </br>
    2-Realizar login </br>
    3-Igresar  usuario y password y hacer clik en Aceptar. </br>
    4-Hacer click  en el Boton "Identificar Cliente" </br>
    5-Visualizar en pantalla el cuadro identificar cliente. </br> 
    6- Seleccionar Tipo de Documento "CUIL" </br>
...
class tstICaja_0030(unittest.TestCase, stICajaInicio, stICaja):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0030(self):
        try:
    ...
    def getDatos(self):
        ...
        self.tipoDoc = self.usuario.get(TIPO_DOC_IDENTIF)
        self.documento =  self.usuario.get(NRO_DOC_IDENTIF)
