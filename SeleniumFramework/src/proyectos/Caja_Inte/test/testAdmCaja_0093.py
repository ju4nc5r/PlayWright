...
@allure.testcase(
    u"test_0093 - Consultas - Totales ingresos, egresos y líquido de caja - Reales", u''
)
@allure.title(u'test_0093 - Consultas - Reales')
...
class tstAdmCaja_0093(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0093(self):
        try:
