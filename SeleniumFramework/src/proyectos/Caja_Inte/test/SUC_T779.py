...
@allure.story(u'Deposito a Terceros')
@allure.testcase(u"ICaja - SUC-T779 - Depósito en efectivo de 3° Superior a $ 280,000 - Por Documento")
@allure.title(u'SUC-T779 - Depósito en efectivo de 3° Superior a $ 280,000')
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
u"""
1.-Ingresar a la pagina Icaja: https://fe-icaja-icaja-front-inte.apps.ocp-np.sis.ad.bia.itau/#/login</br>
2.-Realizar login e ingresar los datos del operador Legajo:UIC10021 / Terminal:IA0500821 / ContraseÃ±a:Ingreso21</br>
3.-Hacer clic en el botÃ³n "INGRESAR"</br>
4.-Validar nombre del Operador "Hola, UIC10021</br>
5.-Hacer clic en la TransacciÃ³n - DepÃ³sito a Terceros</br>
6.-Seleccionar Documento</br>
7.-Ingresar numero de Documento:25227274</br>
...
15.-Validar los datos y tildar la opciÃ³n "Es depositante"</br>
16.-Hacer clic en el Boton "SIGUIENTE"</br>
17.-Hacer clic en el BotÃ³n "CONFIRMAR"</br>
18.-Visualizar el Mensaje - "La finalizo correctamente"</br>
19.-Visualizar el Mensaje - "ImpresiÃ³n finalizada con exito"</br>
20.-Visualizar la impresiÃ³n del ticket</br>
21.-Realizar una ExtracciÃ³n</br>
22.-Hacer clic en el recuadro Hola, UIC10021</br>
23.-Hacer clic en CERRAR SESIÃ“N</br>          
 </br> 
    """
)
class SUC_T779(unittest.TestCase, stICajaInicio, stICaja,stICajaTickets,stAutorizInicio):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T779(self):
        try:
            ...
            self.validarDatosCuenta(self.cuenta2)
            self.validarNombreDelTitular(self.nombreCliente2)
            ...
            self.seleccionarSiguiente3ros()
            self.validarDetalleDeOperacion(self.cuenta2,"pesos",self.importe)
