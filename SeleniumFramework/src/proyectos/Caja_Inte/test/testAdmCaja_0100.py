...
@allure.testcase(
    u"Adm.Caja - Caso de Prueba 0100", u''
)
@allure.title(u'test_0100 - Consultas - Listados Multiples - Pesos')
...
class tstAdmCaja_0100(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0100(self):
        try:
