...
@allure.testcase(
    u"test_0070 - Ingreso Externo del Numerario - Pesos", u''
)
@allure.title(u'test_0070 - Ingreso Externo del Numerario - Pesos')
...
@allure.description(
    ...
    12-Ingresar en numero control (0100)    
    13-Ingresar valor (2000)  
...
class tstICaja_0070(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0070(self):
        try:
