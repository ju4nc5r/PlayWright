...
@allure.testcase(
    u"test_0063 - Extracción en dólares de cuenta en dólares", u''
)
@allure.title(u'test_0063 - Extracción en dólares de cuenta en dólares')
...
class tstICaja_0063(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0063(self):
        try:
