...
@allure.testcase(
    u"Test_085 - Deposito Efectivo", u''
)
@allure.title(u'Test_085 - Deposito Efectivo - Euros en cuenta en euros')
...
@allure.description(
    ...
    15-Seleccionar  cuenta CA EUROS
    16-Hacer clic en seleccionar Moneda operacion
    17-Seleccionar Moneda euros
    18-Ingresar importe 120
...
class tstICaja_0085(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0085(self):
        try:
