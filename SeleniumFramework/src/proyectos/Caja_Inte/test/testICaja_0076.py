...
@allure.testcase(
    u"Test_076 - Egreso Externo del Numerario", u''
)
@allure.title(u'Test_076 - Egreso Externo del Numerario - Euros')
...
@allure.description(
    ...
    7-Visualizar en la pantalla la opcion Egreso Externo del Numerario
    8-Selecionar Moneda
    9-Hacer clic y seleccionar  monedas Euros
    ...
    13-Ingresar valor (50)
    14-Hacer click  en el Boton siguiente
    15-Impresion ok  
    """
)
class tstICaja_0076(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0076(self):
        try:
