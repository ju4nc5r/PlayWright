...
@allure.testcase(u"SUC-T345 - Consultas - Totales ingresos, egresos y líquido de caja - Pesos")
@allure.title(u'SUC-T345 - Consultas - Pesos')
...
8-Validar el item Moneda y Seleccionar Pesos </br>  
...
class SUC_T345(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def test_SUC_T345(self):
        try:
