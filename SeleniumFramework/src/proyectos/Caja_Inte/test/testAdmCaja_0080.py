...
@allure.testcase(
    u"Adm.Caja - Caso de Prueba 0080", u''
)
@allure.title(u'test_0080 - consulta de Movimientos de caja')
@allure.severity(allure.severity_level.NORMAL)
@allure.description(
    u"""
    1-Ingresar a la pagina Administracion de cajas  
    2-Colocar  el usuario y password y hacer clik en Aceptar.  
    3-Hacer click en consultas - Movimientos de caja  
    4-Validar que contenga informacion 
    5-Hacer click  en el Boton Salir "Salir de la aplicacion" 
    """
)
class tstAdmCaja_0080(unittest.TestCase, stAdminConsulta, stAdminInicio):
    def setUp(self):
        inicioAdminCaja(self)
        
    def testAdmCaja_0080(self):
        try:
