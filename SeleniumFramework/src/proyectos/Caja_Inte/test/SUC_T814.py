...
@allure.testcase(u"ICaja - SUC-T814 - Cierre de Caja - Operador UIC10021")
@allure.title(u'SUC-T814 - Cierre de Caja - Operador UIC10021')
...
class SUC_T814(unittest.TestCase, stICajaInicio, stICaja,stAdminInicio,stAdminConsulta,stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def test_SUC_T814(self):
        try:
