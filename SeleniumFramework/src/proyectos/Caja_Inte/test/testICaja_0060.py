...
@allure.testcase(
    u"test_0060 - Extraccion en pesos de cuenta en pesos", u''
)
@allure.title(u'test_0060 - Extraccion en pesos de cuenta en pesos')
...
class tstICaja_0060(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0060(self):
        try:
