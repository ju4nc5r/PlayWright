...
@allure.testcase(
    u"Test_075 - Egreso Externo del Numerario", u''
)
@allure.title(u'Test_075 - Egreso Externo del Numerario - Dolares')
...
@allure.description(
    ...
    13-Ingresar valor (70)
    14-Hacer click  en el Boton siguiente
    15-Impresion ok 
    """
)
class tstICaja_0075(unittest.TestCase, stICajaInicio, stICaja, stICajaTickets):
    def setUp(self):
        inicioICaja(self)
        
    def testICaja_0075(self):
        try:
