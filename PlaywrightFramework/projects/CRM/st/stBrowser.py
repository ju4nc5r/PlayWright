...
class stBrowser():
    ...
    URL = "https://sapfiorihw11.sis.ad.bia.itau:8021/sap/bc/ui5_ui5/ui2/ushell/shells/abap/FioriLaunchpad.html#Shell-home"
    ...
    def video2allure(self):
        ...
        self.allureDriver.attach_video(folder, "Reporte en video")
    ...
    def deslogueo(self):
        ...
        with allure.step(accion):
            ...
            self.page.get_by_role("link", name="Cerrar Sesión").click()
            self.screen2allure(accion)
