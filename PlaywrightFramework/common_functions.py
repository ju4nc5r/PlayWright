...
def get_user_hb(nombre_caso):
    from PlaywrightFramework.utils.excel_file import usuarios
    from PlaywrightFramework.utils.settings import hb_user_excel, hb_user_sheet
...
def get_user(nombre_usuario):
    from PlaywrightFramework.utils.excel_file import usuarios
    from PlaywrightFramework.utils.settings import hb_user_excel, hb_user_login
...
def get_user_caja_inte(nombre_caso):
    from PlaywrightFramework.utils.excel_file import usuarios
    from PlaywrightFramework.utils.settings import caja_user_excel, caja_user_sheet
...
def get_user_IBE_homo(nombre_caso):
    from PlaywrightFramework.utils.excel_file import usuarios
    from PlaywrightFramework.utils.settings import IBE_user_excel, IBE_user_sheet_homo
...
def get_user_caja_homo(nombre_caso):
    from PlaywrightFramework.utils.excel_file import usuarios
    from PlaywrightFramework.utils.settings import caja_user_excel, caja_user_sheet_homo
...
def get_user_caja_homo_suc_50(nombre_caso):
    from PlaywrightFramework.utils.excel_file import usuarios
    from PlaywrightFramework.utils.settings import caja_user_excel, caja_user_sheet_homo_suc_50
...
def get_user_NHBE_homo(nombre_caso):
    from PlaywrightFramework.utils.excel_file import usuarios
    from PlaywrightFramework.utils.settings import NHBE_user_excel, NHBE_user_sheet_homo
...
def test_Modificar_XML_Enviroments(allure_path='../allure-results/'):
    ...
    import shutil
    from os.path import join
    from PlaywrightFramework.utils.settings import allure_xml, browser
